...
if [[ "$executor" == "ReactNetExecutor" ]]; then
  (node /home/lz/rrr/DesktopSampleApp/desktop/bin/ubuntu-server.js 2>&1 > /dev/null) &
fi
...
# Push binaries
  adb push /home/lz/rrr/DesktopSampleApp/desktop/bin/DesktopSampleApp "$app_path/DesktopSampleApp"
...
# Run app locally
  /home/lz/rrr/DesktopSampleApp/desktop/bin/DesktopSampleApp $args
fi
